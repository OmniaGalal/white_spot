...
class AuthCubit extends Cubit<AuthStates>{
  ...
  void register({required String email,required String name,required String password}) async {
    ...
    try{
      ...
      if( userCredential.user?.uid != null )
      {
        ...
        await sendUserDataToFirestore(name: name, email: email, password: password, userID: userCredential.user!.uid );
  ...
  Future<void> sendUserDataToFirestore({required String name,required String email,required String password,required String userID}) async {
    UserModel userModel = UserModel(name: name, email: email, id: userID);
    try{
